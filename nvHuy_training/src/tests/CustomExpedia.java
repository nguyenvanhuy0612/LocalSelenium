...
public class CustomExpedia {
	...
	public void hotelReservation() {
		...
		driver.findElement(By.xpath("//button[@data-lob='hotel']/span[1]")).click();
		...
		driver.findElement(By.cssSelector("label[class='uitk-button-toggle-label'][for='" + starInput + "']")).click();
